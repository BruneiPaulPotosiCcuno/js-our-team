...
const groupContainer = document.getElementById('info-container')
...
for (let i = 0; i < group.length; i++) {
    ...
    //creo il text
    const userInfo = `name: ${user.name}, role: ${user.rol}, photo  ${user.photo}`; 
    userElement.textContent = userInfo;
